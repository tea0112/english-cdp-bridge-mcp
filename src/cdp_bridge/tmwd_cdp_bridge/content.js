...
(function(){
  ...
  function showBridgeNotice(message){
    ...
    n.innerHTML='<div class="tmwd-bridge-notice-icon">i</div><div><div class="tmwd-bridge-notice-title">CDP Bridge connected</div><p class="tmwd-bridge-notice-message"></p></div>';
  ...
  d.addEventListener('click',()=>{if(d._preventClick){d._preventClick=false;return;}showBridgeNotice('Session active\nURL: '+location.href);});
